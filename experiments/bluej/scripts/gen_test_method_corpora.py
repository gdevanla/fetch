...
BASE_DIR = "/Users/gdevanla/Dropbox/private/se_research/myprojects/fetch/experiments/bluej/data"
...
if __name__ == '__main__':
    t = get_test_methods_map(os.path.join(BASE_DIR, "test_methods/test_methods_1"))
